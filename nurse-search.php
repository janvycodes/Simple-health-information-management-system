   ...
   <div class="reslt">
   	<table>
   		<tr>
   			...
   			<td><a href="editpat.php?pattid=<?php echo $row["patient_id"]; ?>">Edit details</a></td>
   			<td><a href="createcon.php?pattid=<?php echo $row["patient_id"]; ?>">Create new consultation</a></td>
   			<td><a href="nurse-home.php">Add new patient</a></td>
   		</tr>
   	</table> 
   </div>
    <?php
