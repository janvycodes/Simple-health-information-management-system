 <?php
    ...
    require 'configure.php';
		...
		if($_SESSION['attempt'] == 3){
			...
			$sql = "SELECT * FROM staff WHERE staff_id = '$staffid' AND role='pharmacist'";
...
<html lang="en">
  <head>
    ...
    <title>Korle Bu Information System | Pharmacist Login</title>
...
<body>
	<Div class="pharmacist">
		<form method="POST" action="pharmacist.php" >
			...
			<input type="text" name="staffid" placeholder="Pharmacist Id" required="required"><br>
