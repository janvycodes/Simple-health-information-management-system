 <?php
    ...
    require 'configure.php';
		...
		if($_SESSION['attempt'] == 3){
			...
			$sql = "SELECT * FROM staff WHERE staff_id = '$staffid' AND role='doctor'";
...
<html lang="en">
  <head>
    ...
    <title>Korle Bu Information System | Doctor Login</title>
...
<body>
	<Div class="doctor">
		<form method="POST" action="doctor.php" >
			<h3>DOCTOR LOGIN</h3>
			<input type="text" name="staffid" placeholder="Doctor Id" required="required"><br>
