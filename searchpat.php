...
?> 
	...
	<div class="search">
		<form method="GET" action="searchpat.php">
		...
		<div class="search-area">
			<?php
					...
					if (isset($_GET['k']) && $_GET['k'] != ''){
						...
						$query_string = "select * from patient where";
						$display_words = "";

						// seperate each of the keywords
						$keywords = explode(' ', $k); 
						foreach($keywords as $word){
							$query_string .= " patient_id LIKE '%".$word."%' OR ";
							$display_words .= $word." ";
						}
...
<td><?php  echo $row['parguard'];?></td>
<td><?php  echo $row['parguard_name'];?></td>
<td><?php  echo $row['parguard_contact'];?></td>
<td><a id='del' href="delpat.php?patid=<?php echo $row["patient_id"]; ?>">Delete</a></td>
  </tr>
   	</table> 
   </div>
    <?php
