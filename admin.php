 <?php
    ...
    require 'configure.php';
		...
		if($_SESSION['attempt'] == 3){
			...
			$sql = "SELECT * FROM staff WHERE staff_id = '$staffid' AND role='administrator'";
...
<html lang="en">
  <head>
    ...
    <title>Korle Bu Information System | Administrator Login</title>
...
<body>
	<Div class="admin">
		<form method="POST" action="admin.php" >
			<h3>ADMIN LOGIN</h3>
			<input type="text" name="staffid" placeholder="Admin Id" required="required"><br>
